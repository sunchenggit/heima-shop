...
// 单个商品选中状态
const onChangeChecked = (item: CartItem) => {
...
const onChangeSelectedAll = () => {
  ...
  // 后端数据更新
  putMemberCaetSelectedAPI({ selected: _isSelectedAll })
}
  ...
  <scroll-view scroll-y class="scroll-view" @scrolltolower="onScrolltolower()">
    ...
    <template v-if="memberStore.profile">
      ...
      <view class="toolbar">
        ...
        <text class="amount">{{ selectedCartListCount }}</text>
