...
const onChange: UniHelper.SwiperOnChange = (event) => {
  curIndex.value = event.detail.current + 1
}
  ...
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      ...
      <view class="preview">
        ...
        <view class="indicator">
          <text class="current">{{ curIndex }}</text>
      ...
      <view class="action">
        <view class="item arrow" @tap="openSkuPopup(SkuMode.Both)">
          ...
          <text class="text ellipsis"> {{ selectArText }} </text>
        </view>
    ...
    <view class="detail panel">
      ...
      <view class="content">
        ...
        <!-- 图片详情 -->
        <image mode="widthFix" v-for="img in goods?.details.pictures" :key="img" :src="img"></image>
      </view>
    </view>
