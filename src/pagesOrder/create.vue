...
const onOrderSubmit = async () => {
  ...
  uni.redirectTo({ url: `/pagesOrder/detail?id=${res.result.id}` })
}
</script>
...
<template>
  <scroll-view scroll-y class="viewport">
    ...
    <navigator
      ...
      class="shipment"
      hover-class="none"
      url="/pagesMember/address?from=order"
    >
    ...
    <navigator v-else class="shipment" hover-class="none" url="/pagesMember/address?from=order">
